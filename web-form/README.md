...
* [`src/web_form/`](src/web_form/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/web_form/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `web-form` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/web_form/config.cljs) defaults to `true` in
...
```clj
(ns web-form.example
  (:require [web-form.config :as config])
